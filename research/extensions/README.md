...
| [Escalation script systems](escalation-script-systems.md) | Gold 10.2.0 fusion upgrade, receiving gate and full mixed-size automatic surface transport; authored contracts and bounded host acceptance. |
