...
// families do not draw alike. The two puff classes blit their bound entry with
// no coverage test at all, the two flame classes blit theirs after the
...
const (
	...
	// StripFamilySmokePuff is the strips-4/5/9 smoke puffer: impact, muzzle,
	// trail, emit-sfx, burning-feature and corpse-column smoke [03 R-FX-02 §3]
	// [06 R-WFX-01 §5].
	StripFamilySmokePuff
	// StripFamilyVentSteam is the geothermal vent's own class on strip 4. It
	// shares the puff record and the puff draw; only its container virtuals
	// differ [03 R-FX-01 §3 addendum §B][05 R-ECO-02 §3].
