...
// bounded cardinal search and the destination legality rules live in the two
// design-document sections named on ModernRules.
func (*ModernRules) YieldObstruction(s *Service, requester *units.Unit, clear world.FootprintRect, closingYard []world.YardCell, tick uint32, urgent bool) {
	if s == nil || s.World == nil || s.Movement == nil || s.Terrain == nil || requester == nil {
		return
	}
