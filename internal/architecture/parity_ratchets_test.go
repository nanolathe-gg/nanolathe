...
var float64Baseline = map[string]int{
	...
	"internal/mission/mission_globals.go":   19,
...
var debtMarkerFileCounts = map[string]map[string]int{
	...
	"todo(question)": {
		...
		"internal/mission/mission_globals.go":      12,
		...
		"internal/session/step.go":                 6,
		"internal/session/visibility.go":           1,
