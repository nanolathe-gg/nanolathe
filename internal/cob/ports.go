...
// The named values are the movement-integration edges MoveRateTransition
// reports; the other engine callbacks reach the VM by their authored script
// name through CallbackBridge, which is the single typed surface for them.
const (
