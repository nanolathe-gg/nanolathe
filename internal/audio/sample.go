...
// keeping this boundary explicit preserves the authored resource name. Each
// stream open reads its file anew and never consults or overwrites a registered
// alias with the same spelling [03 R-AUD-02 §1].
