...
var Baseline = map[string]int{
	...
	"internal/session/composition.go":               13,
	"internal/session/economy.go":                   4,
	"internal/session/loop.go":                      17,
	...
	"internal/visibility/grids.go":                  2,
	"internal/visibility/predicate.go":              1,
	"internal/visibility/sensors.go":                9,
